...
当前路线是需要用户在任务 000 批准的正式建议，不是已经授权的实现计划。

| 编号 | 任务 | 状态 | 永久产物 |
| --- | --- | --- | --- |
| 000 | [确定项目目标与全部产品决策](000-确定项目目标与全部产品决策/README.md) | 规格核对中 | 产品规格、决策、设备证据计划、批准路线 |
| 001 | 完成参考源码与许可证审计 | 待讨论 | 文件级来源矩阵、许可证与允许复用边界 |
| 002 | 建立 x64 组件工程与服务合同 | 待讨论 | 可安装组件、Core targets、版本化服务 ABI、包审计 |
